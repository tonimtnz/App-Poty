...
export function SongHorizontalCard({ eachSong, onPlayClick }) {
  ...
  const shortSongNameDisplay = shortSongName(songName, 60);

  const handlePlayClick = () => {
    onPlayClick(eachSong);
  };

  return (
    <div className="horizontalCard" onClick={handlePlayClick}>
      <div className="img-btn-section-home">
        <img className="song-img-home" src={songImg} />
        <button className="playBtn-home" onClick={handlePlayClick}>
          <svg
            width="12"
            height="18"
            viewBox="0 0 16 25"
